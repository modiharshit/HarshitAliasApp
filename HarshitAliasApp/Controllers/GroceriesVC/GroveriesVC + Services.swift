...
extension GroceriesVC {
    
    func getNearbyGroceries() {
        self.arrBusinesses.removeAll()
        _ = Alamofire.request(GET_GROCERIES + "latitude=\(userLatitude)&longitude=\(userLongitude)", method: .get, parameters: nil, encoding: JSONEncoding.default, headers: authHeader).validate().responseJSON { (response) in
